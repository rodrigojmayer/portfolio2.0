export const projects = [
    {
      ...
      videos: [
        ...
        { src: '01-Log-in-with-gmail',
          title: { es: 'Registro automático e inicio de sesión con Gmail', en: 'Automatic registration and login with Gmail' },
        },
        { src: '02-Create-loan',
          title: { es: 'Crear nuevo prestamo', en: 'Create new loan' },
        },
        { src: '03-Update-loan',
          title: { es: 'Actualizar prestamo', en: 'Update loan' },
        },
        { src: '04-Close-loan',
          title: { es: 'Cerrar prestamo', en: 'Close loan' },
        },
        { src: '05-Finished-filter',
          title: { es: 'Filtrar prestamos finalizados', en: 'Finished loans filter' },
        },
        { src: '06-Expirated-loan',
          title: { es: 'Prestamo vencido', en: 'Expirated loan' },
        },
        { src: '07-Order-alerts-first',
          title: { es: 'Alertas en la parte superior', en: 'Alerts on top' },
        },
        { src: '08-Change-expiration-date',
          title: { es: 'Cambiar fecha de vencimiento', en: 'Change expiration date' },
        },
        { src: '09-Profile',
          title: { es: 'Perfil', en: 'Profile' },
        },
        { src: '10-Theme-color',
          title: { es: 'Modo Oscuro/Claro', en: 'Dark/Light mode' },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      videos: [
        { src: '01-Index_page',
          title: { es: 'Página de inicio', en: 'Index page'},
        },
        { src: '02-New_page',
          title: { es: 'Nueva página', en: 'New page'},
        },
        { src: '03-Entry_page',
          title: { es: 'Página de entrada', en: 'Entry page'},
        },
        { src: '04-Edit_page',
          title: { es: 'Página de edición', en: 'Edit page'},
        },
        { src: '05-Random_page',
          title: { es: 'Página aleatoria', en: 'Random page'},
        },
        { src: '06-Search',
          title: { es: 'Búsqueda', en: 'Search'},
        },
        { src: '07-Not_found',
          title: { es: 'No encontrada', en: 'Not found'},
        },
      ], 
    },
  ]