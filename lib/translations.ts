    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Web application for managing a business’s expenses by selecting customers, payment methods, and products. It allows users to create and organize articles and groups, edit information, add products to a cart, view total expenses, and perform detailed tracking, with the ability to export transactions to a Google Sheets history by customer."
        },
        {
          title: "Network",
          description: 
          "Web application for a Twitter-like social network that allows users to create posts and follow others. Users can browse all posts on the main page, like content, follow profiles, and view personalized feeds such as Following and Liked. The platform also supports editing posts and profile information, including custom profile images or autogenerated avatars.",
        },
        {
      ...
      items: [
        {
          title: "StockPro",
          description:
            `Aplicación web para la gestión de inventario con funciones avanzadas de control de existencias. Permite a los usuarios crear, actualizar y organizar productos, gestionar cantidades de forma individual o masiva, configurar alertas por importe o fecha, y personalizar las vistas con filtros, ordenación y campos personalizados, control de acceso de usuarios y soporte multilingüe.`,
            // "Una plataforma de comercio electrónico completa con integración de pagos, gestión de inventario y panel de administración",
        },
        {
          title: "Expenses Control App",
          description:
            "Aplicación web para gestionar los gastos de una empresa mediante la selección de clientes, métodos de pago y productos. Permite crear y organizar artículos y grupos, editar información, añadir productos a un carrito y visualizar el gasto total, con la posibilidad de exportar las transacciones a un historial en Google Sheets por cliente."
