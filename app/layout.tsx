      ...
      <body className={`font-sans antialiased`}>
        ...
        <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50">
          <a 
            ...
            target="_blank" 
            className="bg-green-500 text-white p-3 md:p-4 rounded-full shadow-2xl hover:bg-green-600 transition-all flex items-center justify-center animate-bounce"
          >
